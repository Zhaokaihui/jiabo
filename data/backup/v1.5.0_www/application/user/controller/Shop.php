                ...
                if (!empty($DetailsId)) {
                    ...
                    if (0 == $post['payment_method']) {
                        ...
                        if (isMobile() && isWeixin()) {
                            ...
                            if (getUsersTplVersion() == 'v2' && isset($post['payment_type'])) { // 第二版会员中心
                                $payment_type = $post['payment_type'];
                                if ('yezf_balance' == $payment_type) { // 余额支付
                                ...
                                else if (in_array($payment_type, ['zxzf_wechat','zxzf_alipay'])) { // 内置第三方在线支付

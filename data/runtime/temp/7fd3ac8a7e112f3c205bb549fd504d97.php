            ...
            <div class="<?php if(empty($channelRow['data']['is_article_pay'])): ?> none <?php endif; ?>">
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        ...
                        <label class="curpoin"><input type="radio" name="restric_type" value="2" <?php if($field['restric_type'] == '2'): ?> checked="checked" <?php endif; ?>>会员专享</label>&nbsp;&nbsp;
                ...
                <dl class="row <?php if(!in_array($field['restric_type'], [1,3])): ?> none <?php endif; ?>" id="dl_users_price">
                    <dt class="tit">
                        <label for="title"><em>*</em>购买价格</label>
                    </dt>
                    <dd class="opt">
                ...
                <div class="<?php if(empty($field['restric_type'])): ?> none <?php endif; ?>" id="div_free_html">
                    <dl class="row" id="dl_part_free">
                        ...
                        <dd class="opt">
                            ...
                            <label class="curpoin"><input type="radio" name="part_free" value="2" <?php if($field['part_free'] == '2'): ?> checked <?php endif; ?> onclick="change_part_free(this);">自动截取</label>&nbsp;
                            <label class="curpoin"><input type="radio" name="part_free" value="1" <?php if($field['part_free'] == '1'): ?> checked <?php endif; ?> onclick="change_part_free(this);">手工录入<?php if($field['part_free'] == '1'): ?><span id="part_free_span" style="color: red;">[编辑]</span><?php endif; ?></label>&nbsp;
                            <span class="err"></span>
                            <p class="notic"></p>
                        </dd>
                    </dl>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/template/admin/login.htm";i:1638802558;s:64:"/data/wwwroot/jiabo/application/admin/template/public/footer.htm";i:1558945818;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="box">
                <form action="" name='theForm' id="theForm" method="post">
                    ...
                    <div class="formText" style="position:relative">
                        ...
                        <img src="/public/static/common/images/loading.gif?v=<?php echo $version; ?>" class="chicuele loading_vertify" id="imgVerify" alt="" onclick="fleshVerify();" style="position:absolute; right: 3px;top: 3px;height: 36px;">
                    </div>
                    <?php endif; ?>

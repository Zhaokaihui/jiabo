<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:35:"./template/pc/lists_article_img.htm";i:1558945818;s:42:"/data/wwwroot/jiabo/template/pc/header.htm";i:1558945818;s:40:"/data/wwwroot/jiabo/template/pc/left.htm";i:1558945818;s:42:"/data/wwwroot/jiabo/template/pc/footer.htm";i:1558945818;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
    ...
    <div class="main_right fr">
      ...
      <div class="page_prolist">
        <ul>
          ...
          <li> <a href="<?php echo $field['arcurl']; ?>" class="img"><img src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>"></a> <a href="<?php echo $field['arcurl']; ?>" class="pro_title"><?php echo $field['title']; ?></a> </li>
      ...
      <script>
                    $(".page_prolist ul li .img img").imgAuto();
                </script>

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:34:"./template/pc/view_article_img.htm";i:1558945818;s:42:"/data/wwwroot/jiabo/template/pc/header.htm";i:1558945818;s:40:"/data/wwwroot/jiabo/template/pc/left.htm";i:1558945818;s:42:"/data/wwwroot/jiabo/template/pc/footer.htm";i:1558945818;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
...
<script type="text/javascript" src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/js/imgauto.js"></script>
</head>
<body>
<div class="header">
  ...
  <div class="w1200">
    ...
    <div class="main_right fr">
      ...
      <div class="show_product">
        ...
        <p class="tips">发布时间:<?php echo MyDate('Y-m-d',$eyou['field']['add_time']); ?></p>
        
        <div class="pro_img"><img src="<?php echo $eyou['field']['litpic']; ?> " alt="<?php echo $eyou['field']['title']; ?>"></div>
      ...
      <div class="flink mt20 clearfix">
        <div class="flink_tit">
          <h3>PROS&nbsp;&nbsp;<span>推荐产品</span></h3>
        </div>
        <div class="pros_list">
          <ul class="clearfix">
          <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "2"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 4; endif; $channelid = ""; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "c",      "noflag"=> "",      "channel"=> $channelid,      "joinaid"=> "",      "keyword"=> "",      "release"=> "off", ); $tag = array (
  'flag' => 'c',
  'orderby' => 'now',
  'row' => '4',
  'typeid' => '2',
            ...
            <li> <a href="<?php echo $field['arcurl']; ?>" class="img"><img src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>"></a> <a href="<?php echo $field['arcurl']; ?>" class="t"><?php echo $field['title']; ?></a> </li>
      ...
      <div class="flink mt20 clearfix">
        ...
        <div class="news_list">
          <ul class="clearfix">
           <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "3"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 5; endif; $channelid = ""; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "c",      "noflag"=> "",      "channel"=> $channelid,      "joinaid"=> "",      "keyword"=> "",      "release"=> "off", ); $tag = array (
  'flag' => 'c',
  'orderby' => 'now',
  'row' => '5',
  'typeid' => '3',
            ...
            <li>
              <p class="fr"><?php echo MyDate('Y-m-d',$field['add_time']); ?></p>
              <a href="<?php echo $field['arcurl']; ?>"><?php echo $field['title']; ?></a> </li>
           <?php ++$e; $aid = 0; $users_id = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>     
          </ul>
        </div>
      </div>
